...
describe("Bubble sort", () => {
  ...
  test("sorts an unsorted array of numbers", () => {
    ...
    expect(selectionSort.sort(array)).toEqual(sortedArray);
  });

  test("handles an already sorted array", () => {
    const array = [1, 2, 3, 4, 5];
    expect(selectionSort.sort(array)).toEqual([1, 2, 3, 4, 5]);
  });
  ...
  test("handles an empty array", () => {
    const array = [];
    expect(selectionSort.sort(array)).toEqual([]);
  });

  test("handles a single-element array", () => {
    const array = [42];
    expect(selectionSort.sort(array)).toEqual([42]);
  });
